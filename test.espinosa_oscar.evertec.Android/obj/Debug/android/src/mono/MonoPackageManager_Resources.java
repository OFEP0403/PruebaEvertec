...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "test.espinosa_oscar.evertec.Android.dll" comes first in this list. */
		"test.espinosa_oscar.evertec.Android.dll",
		"test.services.evertec.dll",
		"test.data_access.evertec.dll",
		"FormsViewGroup.dll",
		"SQLite-net.dll",
		...
		"test.espinosa_oscar.evertec.dll",
